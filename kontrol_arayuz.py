...
UDP_IP = "172.20.10.3"  #uzak kontrol bilgisayarının IP adresi
UDP_PORT = 5000  #uzak kontrol bilgisayarının UDP portu

TCP_IP = "172.20.10.7" #Raspberry Pi'nin IP adresi
...
"color: rgb(50,205,50);") 
        ...
        #self.komut_gonder_tcp(TCP_IP, TCP_PORT, 1) # Raspberry Pi'ye Başlat komutu gönderiliyor
...
"color: rgb(148, 17, 0);")
        ...
        self.komut_gonder_tcp(TCP_IP, TCP_PORT, 'S') # Raspberry Pi'ye Durdur komutu gönderiliyor
